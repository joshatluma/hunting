...
> Run `npx skills add paulklayvc/skills --skill high-leverage-job-hunt` and set it up for this agent.
...
Choose your agent during setup. Add `-g` to install across all your projects.
